...
4ος Στόχος: Να αποκτήσω προγραμματιστική εμπειρία, με σκοπό να βελτιώσω τις δυνατότητές μου σε προγραμματιστικό επίπεδο και να χειρίζομαι με μεγαλύτερη ευκολία γλώσσες προγραμματισμού. 

5ος Στόχος: Να μάθω να χρησιμοποιώ, να επεξεργάζομαι, αλλά και να δημιουργώ καινουρια λογισμικά συστήματα.</p>
...
Παρακάτω υπάρχουν τα link για το συγκεκριμένο παραδοτέο.<br>
Η παράγραφος που πρόσθεσα, αναφέρεται στην γλώσσα "Virtual Basic" και υπάρχει στο κεφαλαιο "Τεχνικές" στην σελίδα 77.</p>
...
### Η παράγραφος που πρόσθεσα στο βιβίο:

<p>Η Virtual Basic είναι μια γλώσσα προγραμματισμού που ανήκει στην "τρίτη γενιά", και διαθέτει ένα ολοκληρωμένο περιβάλλον ανάπτυξης, κατασκευασμένο από την Microsoft. Είναι μια γλώσσα προγραμματισμού χαμηλής δυσκολίας και proerxetai από την γλώσσα BASIC. Η Virtual Basic επιτρέπει την ανάπτυξη εφαρμογών με Grafical User Interface. Ένας χρηστης μπορεί να ολοκληρώσει μια εφαρμογή χρησιμοποιώντας μονο στοιχεια από την Visual Basic.</p>

### Η εικόνα (screenshot) με την προσθήκη μου στο βιβίο:

![keimeno](https://user-images.githubusercontent.com/89204449/202721215-4e96ef28-4c0d-4c1b-838c-1d6734cfa80a.png)
